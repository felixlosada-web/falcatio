    ...
    <main className="max-w-4xl mx-auto px-6 py-28 md:py-36">
      ...
      <header className="mb-20">
        ...
        <p className="text-base md:text-lg leading-relaxed text-black/70 max-w-3xl">
          ...
          Su tesis no es la reunión ornamental de clásicos, sino la construcción
          de una biblioteca de prudencia: un itinerario que conduce desde la
          ciudad justa hasta la conciencia del deber, desde la observación de la
          naturaleza hasta el gobierno de las pasiones, desde la historia
      ...
      <section className="space-y-20 text-[15px] leading-relaxed text-black/70">
        <article>
          ...
          <p className="mb-6">
            ...
            República, de Platón, sitúa la justicia como problema de la ciudad y
            del alma; la Ética nicomáquea, de Aristóteles, convierte la virtud,
            la deliberación y la prudencia en arquitectura práctica de la
            existencia. A esa base griega se añade la tradición romana del deber:
            Cicerón, Séneca y Marco Aurelio trasladan la filosofía al campo de
            la obligación, la serenidad, la disciplina interior y el dominio de
            sí. La posterior presencia de Kant prolonga ese eje hacia una moral
            de la responsabilidad racional, donde el deber ya no se entiende
            como costumbre heredada, sino como exigencia de la razón práctica.
          </p>

          <p className="mb-6">
            Junto a esa línea ética, el conjunto incorpora una segunda gramática:
            la de la naturaleza, el cuerpo y el cambio. Demócrito y Lucrecio
            abren la mirada hacia la materia, el azar y la constitución física
            del mundo; Hipócrates introduce el arte del pronóstico y la atención
            al cuerpo como forma de conocimiento; Ovidio, con las Metamorfosis,
            recuerda que toda identidad vive bajo la ley de la transformación.
          </p>
          ...
          <p className="mb-6">
            ...
            Maquiavelo, en los Discursos, piensa la república, la virtud cívica,
            la memoria de Roma y las condiciones reales de la acción pública.
            Erasmo introduce el ideal humanista del gobernante educado; Gracián
            condensa en El arte de la prudencia una ciencia barroca de la
            ocasión, la reputación y el trato con los hombres.
          </p>

          <p>
            El conjunto no dice simplemente “sabiduría clásica”. Dice algo más
            preciso: la prudencia se forma cuando el pensamiento aprende a pasar
            de la idea a la conducta, de la conducta al deber, del deber a la
            experiencia y de la experiencia a la memoria.
          </p>
        </article>
        ...
        <article>
          ...
          <p>
            ...
            estoica con la experiencia montaigniana; la necedad de Brant con la
            prudencia de Gracián.
          </p>
        </article>
        ...
        <article>
          ...
          <ul className="space-y-3 list-disc pl-5">
            ...
            <li>
              El deber y la soberanía interior: Cicerón, Séneca, Marco Aurelio y
              Kant.
            </li>
            <li>
            ...
            <li>La historia y el conflicto político: Tucídides y Maquiavelo.</li>
            <li>
              El príncipe, la prudencia y la necedad: Erasmo, Gracián y
              Sebastian Brant.
            </li>
            <li>
              La mediación moral entre culturas: Fray Juan Cobo y el Espejo rico
              del claro corazón.
            </li>
            <li>
        ...
        <article className="border-t border-black/10 pt-12">
          <p>
            ...
            entiende que la sabiduría no consiste en poseer respuestas, sino en
