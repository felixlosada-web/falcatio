      ...
      <section className="max-w-[760px] mx-auto">
        ...
        <header className="mb-28">
          ...
          <p className="text-[17px] leading-[1.95] text-black/75 font-light">
            ...
            Scrinium dedicado a la inteligencia del mando. Su tesis no consiste
            en reunir libros sobre poder, guerra o empresa, sino en disponer una
        ...
        <section className="space-y-24 text-[16px] leading-[1.95] text-black/75 font-light">
          <article>
            ...
            <p className="mb-7">
              ...
              dominio de la información, la economía del conflicto y la
              posibilidad de vencer antes de combatir.
            </p>
            ...
            <p className="mb-7">
              El núcleo hispánico aporta una dimensión menos mecánica y más
              moral: Baltasar Gracián y Diego Saavedra Fajardo introducen
              prudencia, disimulo, reputación, virtud política, símbolo y
              gobierno de sí. En ellos, el mando no es solo acción exterior,
              sino disciplina de la apariencia, dominio de la palabra, medida
              del tiempo y administración de la imagen pública.
            </p>

            <p>
              El conjunto no se articula por acumulación, sino por
              correspondencia interna: muestra que mandar nunca ha sido solo
              imponerse, sino leer fuerzas, medir tiempos, custodiar información,
              formar criterio y decidir bajo incertidumbre.
            </p>
          </article>
          ...
          <article>
            ...
            <p className="mb-7">
              ...
              la tienda del general, la mesa de mapas, el despacho del estadista
              y la sala de consejo del gran ejecutivo contemporáneo.
            </p>
          ...
          <article>
            ...
            <p className="mb-7">
              La conversación se articula mediante el Cuaderno de Contexto, que
              no explica desde fuera ni reduce el conjunto a una guía de lectura.
              Su función es disponer entradas, itinerarios y correspondencias
              para que el destinatario comprenda la continuidad profunda entre
              guerra, política, empresa y gobierno.
            </p>

            <p className="mb-7">
              El recorrido puede comenzar en la formación del mando individual:
              carácter, prudencia, reputación, secreto, oportunidad. Puede
              avanzar después hacia la organización del conflicto: estrategia
              directa e indirecta, cálculo de fuerzas, incertidumbre, doctrina,
              moral y fricción. Finalmente, conduce hacia los sistemas complejos:
              redes, tecnología, poder distribuido, debilitamiento de jerarquías
              y nuevas formas de influencia.
            </p>
            ...
            <p className="mb-7">
              ...
              renacentista, un general napoleónico, un presidente de consejo y
              un dirigente empresarial. Cuándo la estrategia es cálculo, cuándo
          ...
          <article>
            ...
            <ul className="space-y-4 list-disc pl-5">
              ...
              <li>
                La doctrina militar: Jomini, Villamartín, San Miguel, Vicente
                Rojo y Peter Paret.
              </li>
          ...
          <article className="border-t border-black/10 pt-12">
            <p>
              El Pensamiento Estratégico: del Príncipe a la Sala de Consejo no
              es una colección sobre liderazgo. Es una forma de conversación con
              la inteligencia histórica del poder: poder como mando, cálculo,
              prudencia, conflicto, persuasión, reputación, red y legado. Su
              valor reside en haber convertido una tradición dispersa —política,
              militar, filosófica y empresarial— en una arquitectura legible
              para quien entiende que decidir no es solo elegir, sino hacerse
              cargo de las consecuencias del mundo que se pone en movimiento.
            </p>
          </article>
