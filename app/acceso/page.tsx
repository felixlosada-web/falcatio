export default function AccesoPage() {
  return (
    <main className="min-h-screen bg-[#F8F6F2] pt-64 pb-32 px-6 md:px-12 lg:px-24 flex items-center justify-center">
      <div className="max-w-[750px] text-center">
        <p className="text-[10px] tracking-[0.3em] uppercase text-black/40 mb-12 font-light">
